const STATUS_LABELS: Record<string, string> = {
  ...
  completed: "已完成",
  needs_labels: "事件标签不足",
  needs_positive_samples: "正样本不足",
  needs_train_samples: "训练正样本不足",
  needs_holdout_samples: "留出正样本不足",
  idle: "空闲",
  open: "打开",
  closed: "已关闭",
  local: "本地",
...
const TEXT_LABELS: Record<string, string> = {
  ...
  not_enough_event_labels: "事件窗口数量低于实验门槛",
  not_enough_manual_labels: "人工标签数量不足",
  no_positive_samples: "没有生成正样本",
  no_train_positive_samples: "训练集没有正样本",
  no_holdout_positive_samples: "留出集没有正样本",
  insufficient_data: "数据不足",
  insufficient_train_data: "训练数据不足",
  window_not_covered: "本地K线未覆盖窗口",
  missing_positive_sample: "缺少前置信号样本",
  missing_ohlcv: "缺少K线数据",
  no_detected_event: "窗口内未识别事件",
  covered: "已覆盖",
